...
public class ChatUI1 extends JFrame {
    ...
    private final ChatUI1 ownInstance;
    ...
    public ChatUI1() {
        ...
        buttonAddChat.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(ChatUI1.this, popupPanel, "Add Chat", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
